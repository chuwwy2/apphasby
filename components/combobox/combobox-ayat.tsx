...
*/
  React.useEffect(()=>{
    const getData = async()=> {
        ...
        // }
            if (surat) {
      const ayats = Array.from({ length: surat.jumlahAyat }, (_, i) => i + 1)
      setOpsiAyat(ayats)

      // ✅ Put your logs here (after data is ready)
      console.log("✅ Surat terpilih:", valueSurat)
      console.log("✅ Jumlah ayat:", surat.jumlahAyat)
      console.log("✅ Opsi ayat yang di-generate:", ayats)
    } else {
      console.log("❌ Surat tidak ditemukan untuk value:", valueSurat)
    }
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          {ayatTerpilih ? `Ayat ke ${ayatTerpilih}`: "Silahkan pilih ayatnya..."}
